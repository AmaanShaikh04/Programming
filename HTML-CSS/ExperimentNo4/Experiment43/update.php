    ...
    <div>
        <?php
            ...
            if(isset($_POST['update']))
            {
                ...
                $sql = "UPDATE flight SET passenger = '$passenger', afrom = '$afrom', tob = '$tob' ,departure = '$departure' ,arrival='$arrival', phonenumber='$phonenumber', email='$email' WHERE 	phonenumber = '$phonenumber';";
                $result = $db->query($sql);
